...
with open('questions.txt','r') as file2:
    for line2 in file2:
        line2=line2.strip()
        dialogue2=dialogue2+line2+input(line2+"是，请输入Yes；否，请输入No")+"."
dialogue2+="Please analyze the MBTI type of this individual based on his responses to these questions. You only need to tell his MBTI personality type, which is a combination of four letters, without adding any further explanation."
